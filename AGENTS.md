...
```bash
python3 .Codex/skills/radiografia-21/references/generar_datos_demo.py --salida demo/datos
```

Correr el motor sobre ese dataset:

```bash
python3 .Codex/skills/radiografia-21/scripts/motor_radiografia.py --reservas demo/datos/reservas.csv --liquidacion demo/datos/liquidacion.csv --hotel "Demo Recoleta 42" --salida demo/salida --demo
```
...
**`evaluar()` en `.Codex/skills/radiografia-21/scripts/motor_radiografia.py` es la única fuente
...
borraron justamente porque divergen. El código vive sólo en `.Codex/skills/radiografia-21/`
...
actualizá también `.Codex/skills/radiografia-21/SKILL.md`: es lo que otra sesión va a leer.
